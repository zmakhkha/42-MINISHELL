...
#    Updated: 2023/07/06 23:53:42 by ayel-fil         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
LDFLAGS = -L/goinfre/ayel-fil/.brew/opt/readline/lib -g -fsanitize=address
CPPFLAGS = -I/goinfre/ayel-fil/.brew/opt/readline/include
